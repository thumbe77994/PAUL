...
$Recordset1 = mysql_query($query_limit_Recordset1, $lyudao) or die(mysql_error());
...
<div class="container">
	<div class="header">
		...
		<ul class="menu list-unstyled">
			...
			<li  class="activate"><a href="news.php">最新消息</a></li>
			<li><a href="#">會員專區</a>
...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left">最新消息</h3>
			...
			<div class="blog_main col-md-9">
				<div class="blog_list">
					<div class="col-md-2 blog_date">
						<span class="date">	<?php echo   date("M");?>					 
						 <p>
						<?php echo   date("d");?><p></p></span>
					
					</div>
					<div class="col-md-10 blog_left">
						<a href="single-page.html"><img src="image/11.jpg" alt="" width="633" height="172" class="img-responsive"/></a>
						<h4><a href="single-page.html">最新消息 </a></h4>
						 
					 
						
						
						
						<table width="100%" border="1" bordercolor="#ECEEEE">
        <tr>
          <td width="187" background="images/hgdfsh.jpg" bgcolor="#F3F3F3"><div align="left" class="style19 style1 style2 price_tenure price_tenure price_tenure price_tenure">日期</div></td>
          <td width="252" background="images/hgdfsh.jpg" bgcolor="#F3F3F3">標題</td>
          <td width="773" background="images/hgdfsh.jpg" bgcolor="#F3F3F3"><div align="left" class="style19 style1 style2 price_tenure price_tenure price_tenure price_tenure">內容</div></td>
        </tr>
        <?php do { ?>
          <tr>
            <td background="images/hgdfsh.jpg" bgcolor="#FFFFFF"> <?php echo $row_Recordset1['n_news']; ?> </td>
            <td background="images/hgdfsh.jpg" bgcolor="#FFFFFF"><?php echo $row_Recordset1['n_title']; ?></td>
            <td background="images/hgdfsh.jpg" bgcolor="#FFFFFF"><div align="left" class="style17 style1 style2 price_tenure price_tenure price_tenure price_tenure"><?php echo $row_Recordset1['n_text']; ?></div></td>
          </tr>

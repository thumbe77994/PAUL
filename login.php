...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left">登入會員</h3>
		<ol class="breadcrumb pull-right">
		  <li><a href="index.php">回首頁</a></li>
		  <li class="active">登入會員</li>
		</ol>
		<div class="clearfix"></div>
	</div>
</div>
			...
			<div class="blog_main col-md-9">
				<div class="blog_list">
					...
					<div class="col-md-10 blog_left">
						<a href="#"><img src="image/6ytghrfgdh.jpg" alt="" width="1637" height="886" class="img-responsive"/></a>
						<h4><a href="#">登入會員 </a></h4>
						...
						<form action="<?php echo $loginFormAction; ?>" method="POST" name="form1" onSubmit="return aaa( );">
 
  <table width="90%" border="1" align="center">
    <tr>
      <td width="90" Style="Font-Size:20pt"><span class="style2">帳號</span></td>
      <td width="230"><input name="acc2" type="text" id="acc2" size="30"  placeholder="帳號" ></td>
      </tr>
    <tr>
      <td Style="Font-Size:20pt"><span class="style2">密碼</span></td>
      <td><input name="pass2" type="password" id="pass2" size="31"  placeholder="密碼" ></td>
      </tr>
    <tr>
      <td colspan="2" Style="Font-Size:16pt"><label for="acc2">
         
          <div align="center">
            <input type="submit" name="button" id="button" value="登入" style="Font-Size:12pt">
            
              <br>
          <a href="signup.php" class="style1">加入會員</a></div>
          </label></td>
      </tr>
  </table>
</form>

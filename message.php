...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left">留言版</h3>
...
<div class="container">
			...
			<div class="blog_main col-md-9">
				<div class="blog_list">
					...
					<div class="col-md-10 blog_left">
						<a href="#"><img src="images/s4.jpg" alt="" width="680" height="480" class="img-responsive"/></a>
						<h4><a href="#">留言版 </a></h4>
  ...
  <table width="100%" border="1" align="center">
    <tr bgcolor="#FFF9DF">
      <td colspan="2" bgcolor="#D4CDC3"><div align="center" class="style2 style9 style24 style38">
        <div align="center">新留言 </div>
      </div></td>
    </tr>
    <tr bgcolor="#FFF9DF">
      <td bgcolor="#D4CDC3"><div align="left" class="style44"><span class="style37">日期</span></div></td>
      <td width="1084" bgcolor="#FFFFFF"><div align="left" class="style44"><span class="style37">
        <input name="t_date" type="hidden" id="t_date" value="<?php echo date("Y-m-d");?> ">
      <?php echo date("Y-m-d");?>  </span></div></td>
    </tr>
    <tr bgcolor="#FFF9DF">
      <td width="108" bgcolor="#D4CDC3"><div align="left" class="style44"><span class="style37">姓名</span></div></td>
      <td bgcolor="#FFFFFF"><div align="left" class="style44">
        <input name="t_name" type="text" id="t_name" size="30%">
      </div></td>
    </tr>
    <tr bgcolor="#FFF9DF">
      <td bgcolor="#D4CDC3"><div align="left" class="style44"><span class="style37">內容</span></div></td>
      <td bgcolor="#FFFFFF"><div align="left" class="style44">
...
<form name="form2" method="post" action="">
  ...
  <table width="100%" border="0" align="center">
    <tr>
      <td bgcolor="#FFFFFF" class="bg-success"><span class="style23 style44 style3 style4"><strong>日期</strong></span></td>
      <td width="466" bgcolor="#FFFFFF"><span class="style3 style45"><strong><?php echo $row_rs['t_date']; ?></strong></span></td>
      </tr>
    <tr>
      <td width="124" bgcolor="#FFFFFF" class="style3 style4 bg-success"><strong>姓名</strong></td>
      <td bgcolor="#FFFFFF"><div align="left" class="style45 style3"><?php echo $row_rs['t_name']; ?></div>        <div align="left" class="style45 style3"></div>        <div align="left" class="style45 style3"></div></td>
      </tr>
    <tr>
      <td bgcolor="#FFFFFF" class="bg-success"><div align="left" class="style23 style44 style3 style4"><strong>內容</strong></div></td>
      <td bgcolor="#FFFFFF"><div align="left" class="style45 style3"><?php echo $row_rs['t_text']; ?></div></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#FFFFFF" class="bg-success"><div align="left" class="style45 style3"><span class="style23 style44 style3 style4"><strong>回應</strong><?php echo $row_rs['t_re']; ?></span></div></td>
      </tr>
    <tr bgcolor="#FFFFCC">
...
<div align="center"><a href="../index.php">
  ...
  <span class="style9">記錄 <?php echo ($startRow_rs + 1) ?> 到 <?php echo min($startRow_rs + $maxRows_rs, $totalRows_rs) ?> 共 <?php echo $totalRows_rs ?> 筆 </span>
